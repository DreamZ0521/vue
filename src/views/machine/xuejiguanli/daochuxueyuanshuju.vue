...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-bottom: 50px">
      ...
      <el-breadcrumb-item>导出学员数据</el-breadcrumb-item>
    </el-breadcrumb>
  </div>
    <div>

        <el-button size="small" type="primary" icon="el-icon-plus" @click="daochu()">导出</el-button>
...
<!--    </el-form>-->
    ...
    <el-table  size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" sortable prop="deptName" label="导出规则名" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="导出字段" width="1200">
      </el-table-column>
...
export default {
  ...
  methods: {
    daochu(){
      this.$router.push('/machine/xuejiguanli/xuejizhuce')
    },
    // 获取数据方法
    getdata(parameter) {
      this.loading = true
