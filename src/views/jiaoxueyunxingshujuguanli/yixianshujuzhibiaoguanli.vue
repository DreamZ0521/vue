...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>一线数据指标管理</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索筛选 -->
...
<!--        <el-button size="small" type="primary" @click="handleunit()">部门设置</el-button>-->
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" sortable prop="deptName" label="用户名" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="姓名" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userRealName" label="人员角色" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userMobile" label="手机号" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userSex" label="信息1" min-width="50">
      </el-table-column>
      <el-table-column align="center" sortable prop="userEmail" label="信息2" min-width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userEmail" label="信息3" min-width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userEmail" label="信息4" min-width="120">
      </el-table-column>
...
<!--      </el-table-column>-->
      <el-table-column label="操作" min-width="300">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="success" @click="resetpwd(scope.$index, scope.row)">评分</el-button>
      ...
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        ...
        <el-form-item label="人员角色" prop="roleId">
          <el-select size="small" v-model="editForm.roleId" placeholder="请选择" class="userRole">
            ...
            <el-option label="大队长" value="2"></el-option>
            <el-option label="参谋" value="2"></el-option>
        ...
        <el-form-item label="信息1" prop="userEmail">
          <el-input size="small" v-model="editForm.userEmail" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="信息2" prop="userEmail">
          <el-input size="small" v-model="editForm.userEmail" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="信息3" prop="userEmail">
          <el-input size="small" v-model="editForm.userEmail" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="信息4" prop="userEmail">
          <el-input size="small" v-model="editForm.userEmail" placeholder="请输入"></el-input>
        </el-form-item>
