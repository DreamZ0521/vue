...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>专业班次一览表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索筛选 -->
...
<!--        <el-button size="small" type="primary" @click="handleunit()">部门设置</el-button>-->
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" sortable prop="deptName" label="专业班次" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userName" label="别名" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userRealName" label="学员队" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userMobile" label="专业" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userSex" label="年纪" min-width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userEmail" label="所在校区" min-width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="editTime" label="额定人数" min-width="120">
  ...
  methods: {
    ...
    getdata(parameter) {
      ...
      let res = {
        ...
        count: 12,
        data: [
          // <el-table-column align="center" sortable prop="deptName" label="年度" width="120">
          // </el-table-column>
          // <el-table-column align="center" sortable prop="userName" label="招生部系" width="120">
          // </el-table-column>
          // <el-table-column align="center" sortable prop="userRealName" label="开设专业" width="120">
          // </el-table-column>
          // <el-table-column align="center" sortable prop="userMobile" label="学制" width="120">
          // </el-table-column>
          // <el-table-column align="center" sortable prop="userSex" label="入学学期" min-width="50">
          // </el-table-column>
          // <el-table-column align="center" sortable prop="userEmail" label="毕业学期" min-width="120">
          // </el-table-column>
          // <el-table-column align="center" sortable prop="editTime" label="备注" min-width="120">
          {
            deptName: '2015春',
            userName: '招生部1',
            userRealName: '专业1',
