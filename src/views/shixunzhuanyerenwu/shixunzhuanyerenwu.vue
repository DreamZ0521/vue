...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>施训专业任务</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索筛选 -->
...
<!--        <el-button size="small" type="primary" @click="handleunit()">部门设置</el-button>-->
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" sortable prop="userName" label="专业名称" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="soeasyName" label="专业简称" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="userRealName" label="院内代码" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="biaozhundaima" label="标准代码" width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="xuekemenlei" label="学科门类" min-width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="rolecengci" label="培养层次" min-width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="biaozhunxuezhi" label="标准学制" min-width="120">
<!--        <template slot-scope="scope">-->
<!--          <div>{{scope.row.editTime|timestampToTime}}</div>-->
<!--        </template>-->
      </el-table-column>
      <el-table-column align="center" sortable prop="userSex" label="授予学位" min-width="120">
      </el-table-column>
      <el-table-column align="center" sortable prop="zhuanyejieshao" label="专业介绍" min-width="120">
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="专业名称" prop="userName">
          <el-input size="small" v-model="editForm.userName" auto-complete="off" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="专业简称" prop="soeasyName">
          <el-input size="small" v-model="editForm.userRealName" auto-complete="off" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="院内代码" prop="userRealName">
          <el-input size="small" v-model="editForm.userRealName" auto-complete="off" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="标准代码" prop="biaozhundaima">
          <el-input size="small" v-model="editForm.userRealName" auto-complete="off" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="培养层次" prop="rolecengci">
        ...
        <el-form-item label="承担院区" prop="roleId">
          <el-select size="small" v-model="editForm.roleId" placeholder="请选择" class="userRole">
            <el-option label="院区1" value="1"></el-option>
            <el-option label="院区2" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="学科门类" prop="xuekemenlei">
          <el-select size="small" v-model="editForm.roleId" placeholder="请选择" class="userRole">
            <el-option label="学科门类1" value="1"></el-option>
            <el-option label="学科门类2" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="标准学制" prop="biaozhunxuezhi">
          <el-select size="small" v-model="editForm.roleId" placeholder="请选择" class="userRole">
            <el-option label="三年" value="1"></el-option>
            <el-option label="五年" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="英文名称" prop="userMobile">
          <el-input size="small" v-model="editForm.userMobile" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="批准文号" prop="userEmail">
          <el-input size="small" v-model="editForm.userEmail" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="专业介绍" prop="zhuanyejieshao">
          <el-input size="small" v-model="editForm.userEmail" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="授予学位" prop="userSex">
          <el-radio v-model="editForm.userSex" label="是">是</el-radio>
          <el-radio v-model="editForm.userSex" label="否">否</el-radio>
        </el-form-item>
        <el-form-item label="建立年月" prop="nianyue">
          <el-time-select size="small" v-model="editForm.userEmail" placeholder=""></el-time-select>
        </el-form-item>
      </el-form>
